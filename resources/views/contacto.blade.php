...
<div class="container my-5">
    ...
    <form action="{{ route('contacto.enviar') }}" method="POST" class="p-4 shadow-lg rounded bg-white" data-aos="zoom-in" style="max-width: 800px; margin: auto;">
        @csrf

        <h3 class="fw-bold mb-3">Datos</h3>
        <div class="row g-3">
            <div class="col-md-6" data-aos="fade-right">
                <label class="form-label fw-semibold">Nombre:</label>
                <input type="text" name="nombre" class="form-control rounded-pill shadow-sm" required>
            </div>
            ...
            <div class="col-md-6" data-aos="fade-right">
                ...
                <input type="text" name="whatsapp" class="form-control rounded-pill shadow-sm" required>
            </div>
            <div class="col-md-6" data-aos="fade-left">
                <label class="form-label fw-semibold">Ciudad:</label>
                <input type="text" name="ciudad" class="form-control rounded-pill shadow-sm" required>
            </div>
        </div>

        <h3 class="fw-bold mt-4 mb-3" data-aos="fade-up">Cotización</h3>

        <div class="mb-3" data-aos="zoom-in">
            <label class="form-label fw-semibold">¿Requiere cotización?</label>
        ...
        <div id="cotizacion_campos" class="cotizacion-seccion">
            <div class="row g-3">
                <div class="col-md-6" data-aos="fade-right">
                    <label class="form-label fw-semibold">Tamaño/Capacidad:</label>
                ...
                <div class="col-md-6" data-aos="fade-left">
                    ...
                    <input type="number" name="cantidad" id="cantidad" class="form-control rounded-pill shadow-sm" min="1">
                </div>
            </div>
            ...
            <div class="row g-3">
                <div class="col-md-6" data-aos="fade-right">
                    ...
                    <select name="tipo" id="tipo" class="form-select rounded-pill shadow-sm">
                ...
                <div class="col-md-6" data-aos="fade-left">
                    ...
                    <select name="material" id="material" class="form-select rounded-pill shadow-sm">
        ...
        <div class="mb-3" data-aos="fade-up">
            ...
            <textarea name="informacion_adicional" class="form-control rounded shadow-sm" rows="3"></textarea>
        </div>
        ...
        <button type="submit" class="btn btn-primary px-4 py-2 d-block mx-auto rounded-pill fw-bold shadow-sm">
            Enviar
        </button>
    </form>
</div>
...
<div class="container my-5">
    <div class="row align-items-center">
        <div class="col-md-6 text-center p-4" data-aos="fade-right">
            <h2 class="fw-bold mb-3">Visítanos</h2>
